...
public class Openttd extends Application {
	...
	public static void index() {
		...
		List<PlayerScore> bestArticGames = Cache.get("bestArticGames", List.class);
		...
		List<PlayerScore> bestDeserticGames = Cache.get("bestDeserticGames", List.class);
		...
		List<PlayerScore> bestHighSpeedGames = Cache.get("bestHighSpeedGames", List.class);
		...
		List<PlayerScore> bestSteamGames = Cache.get("bestSteamGames", List.class);
		...
		List<PlayerScore> bestToylandGames = Cache.get("bestToylandGames", List.class);
